<?php 
	...
	class lms {
			...
			if($i>0)
			{
				while($row = mysqli_fetch_array($ketqua))
				{
					...
					echo '	<table cellpadding="0" cellspacing="0" border="0">
								<tbody>
									<tr>
										<td><a class="nav-link" href="quantrivien_diem.php">'.$dem.'</a></td>
										<td><a class="nav-link" href="quantrivien_diem.php">'.$tenlophoc.'</a></td>
										<td><a class="nav-link" href="quantrivien_diem.php">'.$siso.'</a></td>
										<td><a class="nav-link" href="quantrivien_diem.php">'.$Trangthai.'</a></td>
										<td><a class="nav-link" href="quantrivien_diem.php">1</a></td>
									</tr>
								</tbody>
							</table>';
							$dem++;
			...
			if($i>0)
			{
				while($row = mysqli_fetch_array($ketqua))
				{
					...
					echo '	<table cellpadding="0" cellspacing="0" border="0">
								...
								<tr>
									<td><a class="nav-link" href="quantrivien_diem.php">'.$dem.'</a></td>
									<td><a class="nav-link" href="quantrivien_diem.php">'.$tenkhoahoc.'</a></td>
									<td><a class="nav-link" href="quantrivien_diem.php">'.$ngayBD.'</a></td>
									<td><a class="nav-link" href="quantrivien_diem.php">'.$Trangthai.'</a></td>
									<td><a class="nav-link" href="quantrivien_diem.php"><a href="../../../controller/adminnitor/delete.php?matk='.$makh.'" id="btn-basic-sm-delete">Xóa</a><a href="quantrivien_nguoidung_suanguoidung.php?matk='.$makh.'" id="btn-basic-sm-edit">Sửa</a></a></td>
								</tr>
								</tbody>
							</table>';
							$dem++;
		...
		public function load_dskythi($sql)
		{
			$link = $this->connect();
			$ketqua = mysqli_query($link,$sql);
			mysqli_close($link);
					...
					echo '	<table cellpadding="0" cellspacing="0" border="0">
								<tbody>
									<tr>
										<td><a class="nav-link" href="quantrivien_diem.php">'.$dem.'</a></td>
										<td><a class="nav-link" href="quantrivien_diem.php">'.$tenlophoc.'</a></td>
										<td><a class="nav-link" href="quantrivien_diem.php">'.$giothi.'</a></td>
										<td><a class="nav-link" href="quantrivien_diem.php">'.$ngaythi.'</a></td>
										<td><a class="nav-link" href="quantrivien_diem.php">'.$phongthi.'</a></td>
										<td><a class="nav-link" href="quantrivien_diem.php">'.$siso.'</a></td>
										<td><a class="nav-link" href="quantrivien_diem.php">1</a></td>
									</tr>
								</tbody>
