   <?php
    ...
    //   echo '<script> alert("Xin lỗi bạn không có quyền truy cập vào trang này. Vui lòng đăng nhập để truy cập. Xin cảm ơn.");</script>';
    // }
    ?>
   <!-- Sidebar -->
  ...
  <div id="collapse3" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
    <div class="bg-white py-2 collapse-inner rounded">
     ...
     <!-- Nav Item - Quản Lý Khoá Học -->

     <li class="nav-item">
       <a class="nav-link" href="khoa_hoc.php">
  ...
  <a class="nav-link" href="quan_ly_thu_chi_viewsa.php">
    ...
    <span>Quản Lý Thu Chi</span></a>
     ...
     <!-- <li class="nav-item">
  <a class="nav-link" href="diem_admin.php">
    <i class="fa fa-check-square"></i>
