         ...
         <section class="content bgcolor-4">
            <form action="" method="post">
               ...
               <span class="input input--ruri">
                  <input class="input__field input__field--ruri" placeholder="Tên đăng nhập" type="text" id="tendangnhap" name="tendangnhap" value="<?php echo $p->laycot("SELECT Tendangnhap FROM taikhoan WHERE MaTK = '$laymatk' LIMIT 1"); ?>" />
                  <label class="input__label input__label--ruri" for="input-26">
                  </label>
               </span>
               <span class="input input--ruri">
                  <input class="input__field input__field--ruri" placeholder="Họ và tên" type="text" id="hovaten" name="hovaten" value="<?php echo $p->laycot("SELECT Hovatennguoidung FROM thongtinnguoidung WHERE MaTK = '$laymatk' LIMIT 1"); ?>" />
                  <label class="input__label input__label--ruri" for="input-27">
                  </label>
               </span>
               <span class="input input--ruri">
                  <select class="input__field input__field--ruri" id="phanquyen" style="background-color: RGB(47, 50, 56); color: white" name="phanquyen">
                     <?php
               ...
               <span class="input input--ruri">
                  <input class="input__field input__field--ruri" placeholder="Ngày Sinh" type="date" id="ngaysinh" name="ngaysinh" value="<?php echo $p->laycot("SELECT NgaySinh FROM thongtinnguoidung WHERE MaTK = '$laymatk' LIMIT 1"); ?>" />
                  <label class="input__label input__label--ruri" for="input-26">
                  </label>
               </span>
               <span class="input input--ruri">
                  <input class="input__field input__field--ruri" placeholder="Nơi Sinh" type="text" id="noisinh" name="noisinh" value="<?php echo $p->laycot("SELECT NoiSinh FROM thongtinnguoidung WHERE MaTK = '$laymatk' LIMIT 1"); ?>" />
                  <label class="input__label input__label--ruri" for="input-27">
                  </label>
               </span>
               <span class="input input--ruri">
                  <input class="input__field input__field--ruri" placeholder="Email" type="email" id="email" name="email" value="<?php echo $p->laycot("SELECT Email FROM thongtinnguoidung WHERE MaTK = '$laymatk' LIMIT 1"); ?>" />
                  <label class="input__label input__label--ruri" for="input-26">
                  </label>
               </span>
               <span class="input input--ruri">
                  <input class="input__field input__field--ruri" placeholder="Số Điện Thoại" type="tel" id="sodienthoai" name="sodienthoai" value="<?php echo $p->laycot("SELECT Sdt FROM thongtinnguoidung WHERE MaTK = '$laymatk' LIMIT 1"); ?>" />
                  <label class="input__label input__label--ruri" for="input-27">
                  </label>
               </span>
               <span class="input input--ruri">
                  <input class="input__field input__field--ruri" placeholder="CCCD/CMND" type="text" id="cccd" name="cccd" value="<?php echo $p->laycot("SELECT CCCD FROM thongtinnguoidung WHERE MaTK = '$laymatk' LIMIT 1"); ?>" />
                  <label class="input__label input__label--ruri" for="input-27">
                  </label>
               </span>
               <br>
